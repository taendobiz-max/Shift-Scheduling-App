...
function generateShifts(employees, businessMasters, dateRange, pairGroups, location) {
    return __awaiter(this, void 0, void 0, function () {
        var dates, cumulativeBusinessHistory, batchId, allEmployeeIds, employeeSkillMatrix, _a, preprocessMultiDayBusinesses, filterOutMultiDayBusinesses, multiDayResult, regularBusinessMasters, allShifts, allViolations, allUnassignedBusinesses, allUnassignedEmployees, allConstraintViolations, totalAssignedCount, totalBusinessCount, _loop_4, _i, dates_1, targetDate, isSuccessful;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                ...
                case 1:
                    ...
                    batchId = (0, uuid_1.v4)();
                    allEmployeeIds = employees.map(function (emp) { return emp.employee_id || emp.従業員ID || emp.id; });
                    return [4 /*yield*/, loadSkillMatrixFromDB(allEmployeeIds)];
                case 2:
