                ...
                <tr key={employee.id}>
                  ...
                  <td colSpan={24} className="border border-gray-300 p-0 relative h-12">
                    ...
                    {emptySlots.map((slot, idx) => (
                      <div
                        key={idx}
                        onClickCapture={(e) => { console.log("CLICKED"); e.stopPropagation(); console.log("STOPPED"); console.log("TARGET:", e.target); window.alert("CLICKED"); console.log("ALERT DONE"); window.alert("CLICKED");
