                ...
                <tr key={employee.id}>
                  ...
                  <td colSpan={24} className="border border-gray-300 p-0 relative h-12">
                    ...
                    {emptySlots.map((slot, idx) => (
                      <div
                        key={idx}
                        onClickCapture={(e) => { console.log("CLICKED"); e.stopPropagation(); window.alert("CLICKED"); } } onMouseDownCapture={(e) => { console.log("MOUSEDOWN"); e.stopPropagation(); window.alert("MOUSEDOWN"); } } onPointerDownCapture={(e) => { console.log("POINTERDOWN"); e.stopPropagation(); window.alert("POINTERDOWN"); } } onTouchStartCapture={(e) => { console.log("TOUCHSTART"); e.stopPropagation(); window.alert("TOUCHSTART"); } } onClick={(e) => {
