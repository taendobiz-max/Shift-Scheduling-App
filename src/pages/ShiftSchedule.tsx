  ...
  if (barStyle && businessName) {
    return (
      <div
        ...
        onClick={onClick}
        style={{ pointerEvents: "auto", zIndex: 10000 }} className={`absolute top-2 bottom-2 rounded px-2 flex items-center justify-between text-white text-xs font-medium shadow-md transition-colors z-20 cursor-pointer ${
          isSelected 
                            ...
                            return emptySlots.map((slot, index) => {
                              ...
                              return (
                                <div
                                  ...
                                  style={{ pointerEvents: "auto", zIndex: 10000 }} className={`absolute top-2 bottom-2 rounded border-2 border-dashed flex items-center justify-center text-xs font-medium transition-all z-10 cursor-pointer ${
                                    isSelected 
