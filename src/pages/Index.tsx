...
import { Calendar, Users, Clock, BarChart3, Settings, Zap, UserX, LogOut, TrendingUp, Workflow, User, UserMinus, Smartphone, UserPlus } from 'lucide-react';
          ...
          {getCurrentUser()?.role === 3 && (
            <Link to="/user-registration">
              <Card className="hover:shadow-lg transition-shadow cursor-pointer border-2 border-orange-200 hover:border-orange-400">
                ...
                <CardContent>
                  <p className="text-sm text-gray-600">
                    システムにアクセスできる新しいユーザーを追加します。メールアドレス、パスワード、権限レベルを設定できます。
                  </p>
                </CardContent>
              </Card>
            </Link>
