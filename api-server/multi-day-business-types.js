...
function isMultiDayBusiness(business) {
    var _a;
    return ((_a = business.multi_day_config) === null || _a === void 0 ? void 0 : _a.is_multi_day) === true;
}
/**
 * 業務が指定された日付に適用されるかチェック
 */
function isApplicableDate(business, date) {
    var config = business.multi_day_config;
...
function generateMultiDaySetId(businessId, startDate) {
    return "".concat(businessId, "_").concat(startDate);
}
