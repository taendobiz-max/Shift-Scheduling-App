...
export class ConstraintManager {
  ...
  static async getAllConstraints(): Promise<EnhancedConstraint[]> {
    console.log('🔄 [API_CONSTRAINT_MANAGER] Loading all constraints via UnifiedRuleAdapter');
  ...
  static async getActiveConstraintsByLocation(location: string): Promise<EnhancedConstraint[]> {
    console.log(`🔄 [API_CONSTRAINT_MANAGER] Loading active constraints for location: ${location} via UnifiedRuleAdapter`);
